...
/// The GitHub / Product Hunt source glyph, shared by the feed row and the
/// deep-dive overlay header/title block.
class SourceMark extends StatelessWidget {
  final bool isGithub;
  final double size;
  const SourceMark({super.key, required this.isGithub, this.size = 22});
  ...
  Widget build(BuildContext context) => SizedBox(
        ...
        child: Padding(
          ...
          child: SvgPicture.string(isGithub ? githubMarkSvg : productHuntMarkSvg),
        ),
      );
}
